...
```
{
  "Type" : "AWS::S3::Bucket",
  "Properties" : {
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-accesscontrol)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-accelerateconfiguration)" : AccelerateConfiguration,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-analyticsconfigurations)" : [ AnalyticsConfiguration, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-name)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-crossoriginconfig)" : CorsConfiguration,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-inventoryconfigurations)" : [ InventoryConfiguration, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-lifecycleconfig)" : LifecycleConfiguration,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-loggingconfig)" : LoggingConfiguration,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-metricsconfigurations)" : [ MetricsConfiguration, ... ]
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-notification)" : NotificationConfiguration,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-replicationconfiguration)" : ReplicationConfiguration,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-tags)" : [ Resource Tag, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-versioning)" : VersioningConfiguration,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-websiteconfiguration)" : WebsiteConfiguration
  }
}
```
...
Properties: 
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-accesscontrol): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-accelerateconfiguration):
    AccelerateConfiguration
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-analyticsconfigurations):
    - AnalyticsConfiguration
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-name): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-crossoriginconfig):
    CorsConfiguration
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-inventoryconfigurations):
    - InventoryConfiguration 
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-lifecycleconfig):
    LifecycleConfiguration
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-loggingconfig):
    LoggingConfiguration
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-metricsconfigurations): 
    - MetricsConfiguration
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-notification):
    NotificationConfiguration
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-replicationconfiguration):
    ReplicationConfiguration
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-tags):
    - Resource Tag
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-versioning):
    VersioningConfiguration
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-websiteconfiguration):
...
### Ref<a name="w3ab2c21c10d959c15b2"></a>
...
### Fn::GetAtt<a name="w3ab2c21c10d959c15b4"></a>
...
### Associate a Replication Configuration IAM Role with an S3 Bucket<a name="w3ab2c21c10d959c17b2"></a>
...
#### JSON<a name="w3ab2c21c10d959c17b2b4"></a>
...
#### YAML<a name="w3ab2c21c10d959c17b2b6"></a>
...
### Configure a Static Website with a Routing Rule<a name="w3ab2c21c10d959c17b4"></a>
...
### Enable Cross\-Origin Resource Sharing<a name="w3ab2c21c10d959c17b6"></a>
...
### Manage the Lifecycle for Amazon S3 Objects<a name="w3ab2c21c10d959c17b8"></a>
...
### Log Access Requests for a Specific S3 Bucket<a name="w3ab2c21c10d959c17c10"></a>
...
### Receive S3 Bucket Notifications to an SNS Topic<a name="w3ab2c21c10d959c17c12"></a>
...
### Replicate Objects and Store Them in Another S3 Bucket<a name="w3ab2c21c10d959c17c14"></a>
...
## More Info<a name="w3ab2c21c10d959c19"></a>
