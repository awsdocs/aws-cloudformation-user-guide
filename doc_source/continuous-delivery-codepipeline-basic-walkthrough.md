...
**Email**  
The email address to which AWS CodePipeline sends pipeline notification, such as `myemail@example.com`\.
...
After your stack has been created, AWS CodePipeline starts your new pipeline\. To view its status, see the [AWS CodePipeline console](https://console.aws.amazon.com/codepipeline/)\. From the list of pipelines, choose **WordPress\-test\-pipeline**\.
...
1. Choose the S3 bucket that AWS CodePipeline used as your pipeline's artifact store\.
...
Now that you understand how to build a basic AWS CloudFormation workflow with AWS CodePipeline, you can use the sample template and artifacts as a starting point for building your own\.