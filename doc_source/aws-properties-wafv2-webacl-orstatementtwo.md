# AWS::WAFv2::WebACL OrStatementTwo<a name="aws-properties-wafv2-webacl-orstatementtwo"></a>
...
```
{
  "[Statements](#cfn-wafv2-webacl-orstatementtwo-statements)" : [ StatementThree, ... ]
}
```
