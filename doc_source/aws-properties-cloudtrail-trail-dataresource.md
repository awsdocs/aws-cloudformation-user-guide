...
The `AWS::S3Outposts::Object` and `AWS::ManagedBlockchain::Node` resource types are not valid in basic event selectors\. To log data events on these resource types, use advanced event selectors\.  
*Required*: Yes  
*Type*: String  
