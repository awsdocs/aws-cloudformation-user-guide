...
The provisioned read capacity and write capacity for the table\. For more information, see [Provisioned Throughput Capacity Mode](https://docs.aws.amazon.com/mcs/latest/devguide/ReadWriteCapacityMode.html#ReadWriteCapacityMode.Provisioned) in the the *Amazon Managed Cassandra Service Developer Guide*\.  
*Required*: No  
