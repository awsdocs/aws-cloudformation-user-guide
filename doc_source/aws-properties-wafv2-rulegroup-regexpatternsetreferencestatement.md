...
```
{
  ...
  "[TextTransformations](#cfn-wafv2-rulegroup-regexpatternsetreferencestatement-texttransformations)" : [TextTransformations](aws-properties-wafv2-rulegroup-texttransformations.md)
}
```
