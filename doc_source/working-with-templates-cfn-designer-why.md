...
## Visualize Template Resources<a name="w3ab2c17c18c11b5"></a>
...
## Simplify Template Authoring<a name="w3ab2c17c18c11b7"></a>
...
You can also validate a template directly in Designer\. It provides the same level of validation as the `[ValidateTemplate](http://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/)` API call, which checks that the JSON or YAML syntax is valid, that all referenced parameters are declared, and that there are no circular dependencies\.

## Simplify Editing with the integrated JSON and YAML editor<a name="w3ab2c17c18c11b9"></a>
