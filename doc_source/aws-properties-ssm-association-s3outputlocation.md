...
\(Deprecated\) You can no longer specify this parameter\. The system ignores it\. Instead, AWS Systems Manager automatically determines the Region of the S3 bucket\.  
*Required*: No  
*Type*: String  
*Minimum*: `3`  
*Maximum*: `20`  
