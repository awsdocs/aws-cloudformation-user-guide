...
The security group of the mount target enables a network connection to TCP port 2049, which is required for an NFSv4 client to mount a file system\. For more information on security groups for EC2 instances and mount targets, see [Security](http://docs.aws.amazon.com/efs/latest/ug/security-considerations.html) in the [http://docs.aws.amazon.com/efs/latest/ug/](http://docs.aws.amazon.com/efs/latest/ug/)\.
