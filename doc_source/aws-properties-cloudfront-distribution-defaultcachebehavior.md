...
```
{
  ...
  "[ForwardedValues](#cfn-cloudfront-distribution-defaultcachebehavior-forwardedvalues)" : [ForwardedValues](aws-properties-cloudfront-distribution-forwardedvalues.md),
