...
## Viewing Stack Information<a name="w3ab2c15c13c17b3"></a>
...
For stacks that contain `SSM` parameters, the **Resolved Value** column displays the values that are used in the stack definition for the `SSM` parameters\. For more information, see \.
...
## Stack Status Codes<a name="w3ab2c15c13c17b5"></a>

The following table describes stack status codes:

### <a name="w3ab2c15c13c17b5b4"></a>
...
| REVIEW\_IN\_PROGRESS | Ongoing creation of one or more stacks with an expected StackId but without any templates or resources\. A stack with this status code counts against the maximum possible number of stacks\.  | 
