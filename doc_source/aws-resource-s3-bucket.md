# AWS::S3::Bucket<a name="aws-resource-s3-bucket"></a>
...
## Return values<a name="aws-resource-s3-bucket-return-values"></a>
...
### Granting public access to S3 buckets<a name="aws-resource-s3-bucket--examples--Granting_public_access_to_S3_buckets"></a>
...
#### JSON<a name="aws-resource-s3-bucket--examples--Granting_public_access_to_S3_buckets--json"></a>
...
#### YAML<a name="aws-resource-s3-bucket--examples--Granting_public_access_to_S3_buckets--yaml"></a>
...
### Enabling ACLs<a name="aws-resource-s3-bucket--examples--Enabling_ACLs"></a>
...
#### JSON<a name="aws-resource-s3-bucket--examples--Enabling_ACLs--json"></a>
...
#### YAML<a name="aws-resource-s3-bucket--examples--Enabling_ACLs--yaml"></a>
...
#### YAML<a name="aws-resource-s3-bucket--examples--Configure_a_static_website_with_a_routing_rule--yaml"></a>
