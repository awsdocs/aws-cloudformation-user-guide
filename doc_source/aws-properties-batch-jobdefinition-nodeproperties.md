...
<a name="aws-properties-batch-jobdefinition-nodeproperties-description"></a>The `NodeProperties` property type specifies various properties specific to multi\-node parallel jobs in a job definition\.

<a name="aws-properties-batch-jobdefinition-nodeproperties-inheritance"></a> `NodeProperties` is a property of the [AWS::Batch::JobDefinition](aws-resource-batch-jobdefinition.md) resource type\.
 ...
 *Required*: Yes  
 *Type*: List of [NodeRangeProperty](aws-properties-batch-jobdefinition-noderangeproperty.md) property types  
 *Update requires*: [No interruption](using-cfn-updating-stacks-update-behaviors.md#update-no-interrupt) 
