...
```
{
  ...
  "[TextTransformations](#cfn-wafv2-rulegroup-sqlimatchstatement-texttransformations)" : [ [TextTransformation](aws-properties-wafv2-rulegroup-texttransformation.md), ... ]
}
```
