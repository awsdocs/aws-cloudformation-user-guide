...
```
{
  "[FieldToMatch](#cfn-wafv2-rulegroup-sqlimatchstatement-fieldtomatch)" : [FieldToMatch](aws-properties-wafv2-rulegroup-fieldtomatch.md),
  "[TextTransformations](#cfn-wafv2-rulegroup-sqlimatchstatement-texttransformations)" : [TextTransformations](aws-properties-wafv2-rulegroup-texttransformations.md)
}
```
