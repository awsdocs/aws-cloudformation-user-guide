...
+  [ FleetLaunchTemplateOverridesRequest](https://docs.aws.amazon.com/APIReference/API_FleetLaunchTemplateOverridesRequest.html) in the *Amazon EC2 API Reference*