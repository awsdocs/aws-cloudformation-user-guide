...
| --- | --- | --- | --- | 
|  2\.0\-12 \(Latest; recommended\)  |  6/13/2022  |  Bug fixes for issues on Windows AMI caused by the KB5010359 security patch\.  |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/releasehistory-aws-cfn-bootstrap.html)  | 
