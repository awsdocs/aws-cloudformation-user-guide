...
+ [ MSI \(32\-bit Windows\)](https://s3.amazonaws.com/cloudformation-examples/aws-cfn-bootstrap-latest.win64.msi)

+ [ MSI \(64\-bit Windows\)](https://s3.amazonaws.com/cloudformation-examples/aws-cfn-bootstrap-latest.win32.msi)


| Version | Release Date | Change Description | Download Packages | 
| --- | --- | --- | --- | 
|  1\.4\-29 \(Latest; recommended\)  |  2/12/2018  |  Extending support for newer AWS regions\.  |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/releasehistory-aws-cfn-bootstrap.html)  | 
