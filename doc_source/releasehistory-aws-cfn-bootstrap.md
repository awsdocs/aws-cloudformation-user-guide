...
| --- | --- | --- | --- | 
|  2\.0\-10 \(Latest; recommended\)  |  1/11/2022  |  Added support for Zypper package manager and systemd service management tool\.  |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/releasehistory-aws-cfn-bootstrap.html)  | 
