...
| [AWS::IoTThingsGraph::FlowTemplate](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotthingsgraph-flowtemplate.html) | FlowTemplateSummary |  | 
...
|  [AWS::Pinpoint::ADMChannel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-admchannel.html)  |  The ID of the Amazon Pinpoint app that the channel is associated with\.  |   | 
|  [AWS::Pinpoint::APNSChannel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-apnschannel.html)  | The ID of the Amazon Pinpoint app that the channel is associated with\. |   | 
|  [AWS::Pinpoint::APNSSandboxChannel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-apnssandboxchannel.html)  | The ID of the Amazon Pinpoint app that the channel is associated with\. |   | 
|  [AWS::Pinpoint::APNSVoipChannel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-apnsvoipchannel.html)  | The ID of the Amazon Pinpoint app that the channel is associated with\. |   | 
|  [AWS::Pinpoint::APNSVoipSandboxChannel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-adnsvoipsandboxchannel.html)  | The ID of the Amazon Pinpoint app that the channel is associated with\. |   | 
|  [AWS::Pinpoint::App](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-admchannel.html)  |  Name  |   | 
|  [AWS::Pinpoint::ApplicationSettings](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-applicationsettings.html)  | The ID of the Amazon Pinpoint app that you're specifying the settings for\. |   | 
|  [AWS::Pinpoint::BaiduChannel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-baiduchannel.html)  | The ID of the Amazon Pinpoint app that the channel is associated with\. |   | 
|  [AWS::Pinpoint::Campaign](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-campaign.html)  | The ID of the Amazon Pinpoint app that the campaign is associated with, and the unique ID of the segment that the campaign targets\. |   | 
|  [AWS::Pinpoint::EmailChannel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-emailchannel.html)  | The ID of the Amazon Pinpoint app that the channel is associated with\. |   | 
|  [AWS::Pinpoint::EventStream](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-eventstream.html)  | The ID of the Amazon Pinpoint app that the event stream is associated with\. |   | 
|  [AWS::Pinpoint::GCMChannel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-gcmchannel.html)  | The ID of the Amazon Pinpoint app that the channel is associated with\. |   | 
|  [AWS::Pinpoint::SMSChannel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-smschannel.html)  | The ID of the Amazon Pinpoint app that the channel is associated with\. |   | 
|  [AWS::Pinpoint::Segment](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-segment.html)  | The ID of the Amazon Pinpoint app that the segment is associated with\. |   | 
|  [AWS::Pinpoint::VoiceChannel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-voicechannel.html)  | The ID of the Amazon Pinpoint app that the channel is associated with\. |   | 
