...
```
{
  "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-replicationconfiguration-role)" : String,
  "[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-replicationconfiguration-rules)" : [ Rule, ... ]
}
```
...
```
[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-replicationconfiguration-role): String
[[ERROR] BAD/MISSING LINK TEXT](#cfn-s3-bucket-replicationconfiguration-rules):
  - Rule
```
