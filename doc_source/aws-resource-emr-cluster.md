...
```
{
  ...
  "Properties" : {
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-additionalinfo)" : JSON object,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-applications)" : [ Applications, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-autoscalingrole)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-bootstrapactions)" [ Bootstrap Actions, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-configurations)" : [ Configurations, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticmapreduce-cluster-customamiid)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticmapreduce-cluster-ebsrootvolumesize)" : Integer,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-instances)" : JobFlowInstancesConfig,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-jobflowrole)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-loguri)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-name)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-releaselabel)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-scaledownbehavior)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-securityconfiguration)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-servicerole)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-tags)" : [ Resource Tag, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-visibletoallusers)" : Boolean
  }
}
```
...
Properties: 
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-additionalinfo): JSON object
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-applications):
    - Applications
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-autoscalingrole): String      
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-bootstrapactions):
    - Bootstrap Actions
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-configurations):
    - Configurations        
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticmapreduce-cluster-customamiid): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticmapreduce-cluster-ebsrootvolumesize): Integer
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-instances):
  ...
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-securityconfiguration): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-servicerole): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-tags):
    - Resource Tag
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-emr-cluster-visibletoallusers): Boolean
```

## Properties<a name="w3ab2c21c10d616b9"></a>
