...
+ [Return Values](#w3ab2c21c10d271c11)
+ [Examples](#w3ab2c21c10d271c13)
...
```
{
  ...
  "Properties" : {
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-configrulename)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-description)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-inputparameters)" : { ParameterName : Value },
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-maximumexecutionfrequency)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-scope)" : Scope,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-source)" : Source
  }
}
```
...
Properties:
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-configrulename): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-description): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-inputparameters):
    ParameterName : Value
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-maximumexecutionfrequency): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-scope):
    Scope
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-config-configrule-source):
    Source
```
...
## Return Values<a name="w3ab2c21c10d271c11"></a>
...
## Examples<a name="w3ab2c21c10d271c13"></a>

### <a name="w3ab2c21c10d271c13b2"></a>
...
### Rule Using Lambda Function<a name="w3ab2c21c10d271c13b4"></a>
