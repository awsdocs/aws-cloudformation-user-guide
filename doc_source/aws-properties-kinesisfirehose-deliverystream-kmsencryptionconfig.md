# Amazon Kinesis Data Firehose DeliveryStream KMSEncryptionConfig<a name="aws-properties-kinesisfirehose-deliverystream-kmsencryptionconfig"></a>
...
`KMSEncryptionConfig` is a property of the [Amazon Kinesis Data Firehose DeliveryStream KMSEncryptionConfig](#aws-properties-kinesisfirehose-deliverystream-kmsencryptionconfig) property type\.
