...
## Syntax<a name="w3ab2c21c10d289b7"></a>
...
```
{
   ...
   "Properties": {
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-availability-zones)": [ String, ... ],
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-cluster-name)": String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-description)": String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-iam-role-arn)": String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-node-type)": String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-notification-topic-arn)": String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-parameter-group-name)": String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-preferred-maintenance-window)": String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-replication-factor)": Integer,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-security-group-ids)": [ String, ... ],
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-subnet-group-name)": String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-dax-cluster-tags)": { String:String, ... }
    }
}
```
