...
The `MinSuccessfulInstancesPercent` parameter applies only to instances only for signaling purpose\. To specify the number of instances in your autoscaling group, see the `MinSize`, `MaxSize`, and `DesiredCapacity` properties fo the [AWS::AutoScaling::AutoScalingGroup](aws-properties-as-group.md) resource\.  
*Default*: `100`  
*Type*: Integer  
*Required*: No
...
### Add an UpdatePolicy to an Auto Scaling Group<a name="w2922ab1c21c19c23c17b4"></a>
...
### AutoScalingReplacingUpdate Policy<a name="w2922ab1c21c19c23c17b6"></a>
...
### Maintain Availability When Updating the Metadata for the cfn\-init Helper Script<a name="w2922ab1c21c19c23c17b8"></a>
...
### Original Template<a name="w2922ab1c21c19c23c17c10"></a>
...
### Updated Logical ID<a name="w2922ab1c21c19c23c17c12"></a>
