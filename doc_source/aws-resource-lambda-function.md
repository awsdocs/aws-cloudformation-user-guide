...
```
{
  ...
  "Properties" : {
      ...
      "[Tags](#cfn-lambda-function-tags)" : [ [Serverless Tags](https://github.com/awslabs/serverless-application-model/blob/master/versions/2016-10-31.md#awsserverlessfunction), ... ],
...
Properties: 
  ...
  [Tags](#cfn-lambda-function-tags): 
    - [Serverless Tags](https://github.com/awslabs/serverless-application-model/blob/master/versions/2016-10-31.md#awsserverlessfunction)
  [Timeout](#cfn-lambda-function-timeout): Integer
