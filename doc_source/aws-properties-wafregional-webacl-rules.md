...
## Syntax<a name="w3ab2c21c14e1723b5"></a>

### JSON<a name="aws-properties-wafregional-webacl-rules-syntax.json"></a>

```
{
  "[[ERROR] BAD/MISSING LINK TEXT](#cfn-wafregional-webacl-rules-action)" : String,
  "[[ERROR] BAD/MISSING LINK TEXT](#cfn-wafregional-webacl-rules-priority)" : Integer,
  "[[ERROR] BAD/MISSING LINK TEXT](#cfn-wafregional-webacl-rules-ruleid)" : String
}
```
...
## Properties<a name="w3ab2c21c14e1723b7"></a>
