...
## Declaration<a name="w13ab1c21c24c55b7"></a>
...
## Parameters<a name="w13ab1c21c24c55b9"></a>
...
## Return Value<a name="w13ab1c21c24c55c11"></a>

A list of string values\.

## Examples<a name="w13ab1c21c24c55c13"></a>

The following examples demonstrate the behavior of the `Fn::Split` function\.

### Simple List<a name="w13ab1c21c24c55c13b4"></a>
...
### List with Empty String Values<a name="w13ab1c21c24c55c13b6"></a>
...
#### JSON<a name="w13ab1c21c24c55c13b6b4"></a>

```
1. { "Fn::Split" : [ "|" , "a||c|" ] }
```

#### YAML<a name="w13ab1c21c24c55c13b6b6"></a>
...
### Split an Imported Output Value<a name="w13ab1c21c24c55c13b8"></a>
...
#### JSON<a name="w13ab1c21c24c55c13b8b4"></a>

```
1. { "Fn::Select" : [ "2", { "Fn::Split": [",", {"Fn::ImportValue": "AccountSubnetIDs"}]}] }
```

#### YAML<a name="w13ab1c21c24c55c13b8b6"></a>

```
1. !Select [2, !Split [",", !ImportValue AccountSubnetIDs]]
```

## Supported Functions<a name="w13ab1c21c24c55c15"></a>
