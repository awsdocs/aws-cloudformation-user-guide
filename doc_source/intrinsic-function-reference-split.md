...
## Declaration<a name="w9928ab1c33c28c55b7"></a>
...
## Parameters<a name="w9928ab1c33c28c55b9"></a>
...
## Return value<a name="w9928ab1c33c28c55c11"></a>

A list of string values\.

## Examples<a name="w9928ab1c33c28c55c13"></a>

The following examples demonstrate the behavior of the `Fn::Split` function\.

### Simple list<a name="w9928ab1c33c28c55c13b5"></a>
...
### List with empty string values<a name="w9928ab1c33c28c55c13b7"></a>
...
#### JSON<a name="w9928ab1c33c28c55c13b7b5"></a>

```
1. { "Fn::Split" : [ "|" , "a||c|" ] }
```

#### YAML<a name="w9928ab1c33c28c55c13b7b7"></a>
...
### Split an imported output value<a name="w9928ab1c33c28c55c13b9"></a>
...
#### JSON<a name="w9928ab1c33c28c55c13b9b5"></a>

```
1. { "Fn::Select" : [ "2", { "Fn::Split": [",", {"Fn::ImportValue": "AccountSubnetIDs"}]}] }
```

#### YAML<a name="w9928ab1c33c28c55c13b9b7"></a>

```
1. !Select [2, !Split [",", !ImportValue AccountSubnetIDs]]
```

## Supported functions<a name="w9928ab1c33c28c55c15"></a>
