...
## Declaration<a name="w2ab1c33c27c60b7"></a>
...
## Parameters<a name="w2ab1c33c27c60b9"></a>
...
## Return value<a name="w2ab1c33c27c60c11"></a>

A list of string values\.

## Examples<a name="w2ab1c33c27c60c13"></a>

The following examples demonstrate the behavior of the `Fn::Split` function\.

### Simple list<a name="w2ab1c33c27c60c13b5"></a>
...
### List with empty string values<a name="w2ab1c33c27c60c13b7"></a>
...
#### JSON<a name="w2ab1c33c27c60c13b7b5"></a>

```
1. { "Fn::Split" : [ "|" , "a||c|" ] }
```

#### YAML<a name="w2ab1c33c27c60c13b7b7"></a>
...
### Split an imported output value<a name="w2ab1c33c27c60c13b9"></a>
...
#### JSON<a name="w2ab1c33c27c60c13b9b5"></a>

```
1. { "Fn::Select" : [ "2", { "Fn::Split": [",", {"Fn::ImportValue": "AccountSubnetIDs"}]}] }
```

#### YAML<a name="w2ab1c33c27c60c13b9b7"></a>

```
1. !Select [2, !Split [",", !ImportValue AccountSubnetIDs]]
```

## Supported functions<a name="w2ab1c33c27c60c15"></a>
