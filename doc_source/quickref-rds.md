...
This example shows an Amazon RDS DBSecurityGroup resource with ingress authorization for the specified CIDR range in the format ddd\.ddd\.ddd\.ddd/dd\. For details, see  and \.
