...
**Note**  
AWS CloudFormation does not automatically create tags \(key–value pairs\) for an Elastic Load Balancing load balancer\. You must use the [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-tags) property to create tags to associate with the load balancer\.


+ [Syntax](#aws-resource-elasticloadbalancingv2-loadbalancer-syntax)
+ [Properties](#w3ab2c21c10d603c10)
+ [Return Values](#w3ab2c21c10d603c12)
+ [Examples](#w3ab2c21c10d603c14)
...
```
{
  ...
  "Properties" : {    
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-loadbalancerattributes)" : [ LoadBalancerAttributes, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-name)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-scheme)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-securitygroups)" : [ String, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-subnetmappings)" : [ SubnetMapping, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-subnets)" : [ String, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-tags)" : [ Resource Tag, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-type)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-ipaddresstype)" : String
  }
}
```
...
Type: "AWS::ElasticLoadBalancingV2::LoadBalancer"
Properties:
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-loadbalancerattributes):
    - LoadBalancerAttributes
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-name): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-scheme): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-securitygroups):
    - String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-subnetmappings):
    - SubnetMapping
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-subnets):
    - String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-tags):
    - Resource Tag
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-type): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-elasticloadbalancingv2-loadbalancer-ipaddresstype): String
```

## Properties<a name="w3ab2c21c10d603c10"></a>
...
### Ref<a name="w3ab2c21c10d603c12b2"></a>
...
### Fn::GetAtt<a name="w3ab2c21c10d603c12b4"></a>
...
## Examples<a name="w3ab2c21c10d603c14"></a>
