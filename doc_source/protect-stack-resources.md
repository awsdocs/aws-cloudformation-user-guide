...
The `Principal` element is required, but supports only the wild card \(`*`\), which means that the statement applies to all [principals](http://docs.aws.amazon.com/general/latest/gr/glos-chap.html#principal)\.
...
### Prevent Updates to All Stack Resources<a name="w3ab2c15c17c29c21b4"></a>
...
### Prevent Updates to a Single Resource<a name="w3ab2c15c17c29c21b6"></a>
...
### Prevent Updates to All Instances of a Resource Type<a name="w3ab2c15c17c29c21b8"></a>
...
### Prevent Replacement Updates for an Instance<a name="w3ab2c15c17c29c21c10"></a>
...
### Prevent Updates to Nested Stacks<a name="w3ab2c15c17c29c21c12"></a>
