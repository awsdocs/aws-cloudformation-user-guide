...
Use the `TagSpecifications` property to tag a launch template on creation\.  | March 11, 2021 | 
...
| [New resource](AWS_RDS.md) | The following resources was added: AWS::RDS::DBProxyEndpoint\. 
