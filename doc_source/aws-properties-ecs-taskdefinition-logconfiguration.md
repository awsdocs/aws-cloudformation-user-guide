# AWS::ECS::TaskDefinition LogConfiguration<a name="aws-properties-ecs-taskdefinition-logconfiguration"></a>

The `LogConfiguration` property specifies log configuration options to send to a custom log driver for the container\.

## Syntax<a name="aws-properties-ecs-taskdefinition-logconfiguration-syntax"></a>

To declare this entity in your AWS CloudFormation template, use the following syntax:

### JSON<a name="aws-properties-ecs-taskdefinition-logconfiguration-syntax.json"></a>
...
### YAML<a name="aws-properties-ecs-taskdefinition-logconfiguration-syntax.yaml"></a>
...
## Properties<a name="aws-properties-ecs-taskdefinition-logconfiguration-properties"></a>
