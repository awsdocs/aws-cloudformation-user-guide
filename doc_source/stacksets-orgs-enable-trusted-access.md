...
+ Enable trusted access with AWS Organizations\. After trusted access is enabled, StackSets creates the necessary IAM roles in the organization management account and target accounts when you create stack sets with service\-managed permissions\.
**Note**  
...
1. Determine which AWS account is the *administrator account*\. For stack sets with service\-managed permissions, the administrator account is the management account for your organization\.
