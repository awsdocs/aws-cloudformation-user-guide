...
If you specify an API Gateway REST API or Api destination as a target, you can use this parameter to specify headers, path parameter, query string keys/values as part of your target invoking request\.  
*Required*: No  
