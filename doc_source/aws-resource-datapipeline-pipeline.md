...
+ [Properties](#w3ab2c21c10d284b9)
+ [Return Values](#w3ab2c21c10d284c11)
+ [Example](#w3ab2c21c10d284c13)
...
```
{
  ...
  "Properties" : {
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-activate)" : Boolean,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-description)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-name)" : String,
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-parameterobjects)" : [ Parameter object, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-parametervalues)" : [ Parameter value, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-pipelineobjects)" : [ Pipeline object, ... ],
    "[[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-pipelinetags)" : [ Pipeline tag, ... ]
  }
}
```
...
Properties:
  ...
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-description): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-name): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-parameterobjects):
    - Parameter object
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-parametervalues):
    - Parameter value
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-pipelineobjects):
    - Pipeline object
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-datapipeline-pipeline-pipelinetags):
    - Pipeline tag
```

## Properties<a name="w3ab2c21c10d284b9"></a>
...
*Update requires*: Some interruptions\. Not all objects, fields, and values can be updated\. Restrictions on what can be updated are documented in [Editing Your Pipelines](http://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-manage-pipeline-modify-console.html) in the *AWS Data Pipeline Developer Guide*\.
...
## Return Values<a name="w3ab2c21c10d284c11"></a>

### Ref<a name="w3ab2c21c10d284c11b2"></a>
...
## Example<a name="w3ab2c21c10d284c13"></a>
