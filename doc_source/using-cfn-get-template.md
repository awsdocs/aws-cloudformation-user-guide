...
AWS CloudFormation stores the template you use to create your stack as part of the stack\. To retrieve the template from AWS CloudFormation use the [https://docs.aws.amazon.com/cli/latest/reference/cloudformation/get-template.html](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/get-template.html) command\.
