...
This type supports updates\. For more information about updating this resource, see [PutMetricAlarm](http://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_PutMetricAlarm.html)\. For more information about updating stacks, see \.


+ [Syntax](#aws-resource-cw-alarm-syntax)
+ [Properties](#aws-properties-cw-alarm-prop)
+ [Return Values](#aws-properties-cw-alarm-ref)
+ [Examples](#w3ab2c21c10d203c15)
...
```
{
   ...
   "Properties" : {
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-actionsenabled)" : Boolean,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-alarmactions)" : [ String, ... ],
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-alarmdescription)" : String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-alarmname)" : String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-comparisonoperator)" : String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-dimensions)" : [ Dimension, ... ],
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-evaluatelowsamplecountpercentile)" : String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-evaluationperiods)" : Integer,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-extendedstatistic)" : String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-insufficientdataactions)" : [ String, ... ],
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-metricname)" : String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-namespace)" : String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-okactions)" : [ String, ... ],
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-period)" : Integer,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-statistic)" : String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-threshold)" : Double,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-treatmissingdata)" : String,
      "[[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-unit)" : String
   }
}
```
...
Properties:
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-actionsenabled): Boolean
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-alarmactions):
    - String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-alarmdescription): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-alarmname): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-comparisonoperator): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-dimensions):
    - Dimension
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-evaluatelowsamplecountpercentile): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-evaluationperiods): Integer
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-extendedstatistic): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-insufficientdataactions):
    - String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-metricname): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-namespace): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-okactions):
    - String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-period): Integer
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-statistic): String
  [[ERROR] BAD/MISSING LINK TEXT](#cfn-cloudwatch-alarms-threshold): Double
...
### Ref<a name="w3ab2c21c10d203c13b2"></a>
...
## Examples<a name="w3ab2c21c10d203c15"></a>
