...
#### JSON<a name="aws-resource-waf-sqlinjectionmatchset--examples--Find_SQL_Injections--json"></a>
...
#### YAML<a name="aws-resource-waf-sqlinjectionmatchset--examples--Find_SQL_Injections--yaml"></a>
...
### Associate a SQL Injection Match Set with a Web ACL Rule<a name="aws-resource-waf-sqlinjectionmatchset--examples--Associate_a_SQL_Injection_Match_Set_with_a_Web_ACL_Rule"></a>

The following example associates the `SqlInjDetection` match set with a web access control list \(ACL\) rule\.

#### JSON<a name="aws-resource-waf-sqlinjectionmatchset--examples--Associate_a_SQL_Injection_Match_Set_with_a_Web_ACL_Rule--json"></a>
...
#### YAML<a name="aws-resource-waf-sqlinjectionmatchset--examples--Associate_a_SQL_Injection_Match_Set_with_a_Web_ACL_Rule--yaml"></a>
...
### Create a Web ACL<a name="aws-resource-waf-sqlinjectionmatchset--examples--Create_a_Web_ACL"></a>
...
#### JSON<a name="aws-resource-waf-sqlinjectionmatchset--examples--Create_a_Web_ACL--json"></a>
...
#### YAML<a name="aws-resource-waf-sqlinjectionmatchset--examples--Create_a_Web_ACL--yaml"></a>
