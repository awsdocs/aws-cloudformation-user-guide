...
## Examples<a name="aws-properties-s3-websiteconfiguration-routingrules-redirectrule--examples"></a>



### Configure a static website with a routing rule<a name="aws-properties-s3-websiteconfiguration-routingrules-redirectrule--examples--Configure_a_static_website_with_a_routing_rule"></a>
...
#### JSON<a name="aws-properties-s3-websiteconfiguration-routingrules-redirectrule--examples--Configure_a_static_website_with_a_routing_rule--json"></a>
...
#### YAML<a name="aws-properties-s3-websiteconfiguration-routingrules-redirectrule--examples--Configure_a_static_website_with_a_routing_rule--yaml"></a>
